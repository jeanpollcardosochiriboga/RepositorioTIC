...
Prototipo de ciberseguridad. Dashboard en tiempo real para detectar dispositivos en la red LAN, monitorear consultas DNS y controlar políticas de filtrado en un router OpenWrt, todo visualizado con D3.js a través de Node-RED.
